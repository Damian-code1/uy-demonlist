...
export const SANCTIONS_ROLES        = ['list_mod', 'admin', 'manager', 'owner']; // panel admin general (niveles/submissions) — list_mod+
export const STAFF_SANCTIONS_ROLES  = ['admin', 'manager', 'owner'];             // panel de SANCIONES — admin+ (sin list_mod)
