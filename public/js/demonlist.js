  ...
  box.innerHTML = `
    ...
    <div class="lm-body">
      ...
      <div class="lm-level-id-row">
        ...
        <button class="lm-level-id-btn" id="copyLevelIdBtn" data-id="${level.aredl_level_id}" title="Copiar ID al portapapeles">
          <span class="lm-level-id-num">${level.aredl_level_id}</span>
