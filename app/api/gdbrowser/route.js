...
function buildLevelData(lvl) {
  return {
    ...
    difficultyFace: lvl.difficultyFace || lvl.difficulty || null,
    stars:      lvl.stars,
    length:     lvl.length,
    downloads:  lvl.downloads,
    likes:      lvl.likes,
    song:       lvl.song?.name || lvl.songName || null,
    coins:      lvl.coins      ?? null,
    verifiedCoins: lvl.verifiedCoins ?? false,
    featured:   lvl.featured   ?? false,
    epic:       lvl.epic       ?? false,
    legendary:  lvl.legendary  ?? false,
    mythic:     lvl.mythic     ?? false,
    objects:    lvl.objects    ?? null,
    orbs:       lvl.orbs       ?? null,
    cp:         lvl.cp         ?? null,
    gameVersion: lvl.gameVersion ?? null,
  };
}